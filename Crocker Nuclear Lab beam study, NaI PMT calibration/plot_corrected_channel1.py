...
figure.suptitle("Channel 1 - Main", fontsize=22, fontname='Times new Roman', y=0.97)
...
no_source = SpecificRun('No source', '0', 'No_source.csv', 'black', 0, 1, 0, 1)
...
for measurement_type in ['Height', 'Area']:
    ...
    fig.suptitle(f"Channel 1 - Pulse {measurement_type} residuals", fontsize=22, fontname='Times new Roman', y=0.95)
    ax_list = ['00', '01', '02', '10', '11', '12']
